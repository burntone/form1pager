document.addEventListener('DOMContentLoaded', () => {
  ...
  if (canvas && window.THREE) {
    ...
    if (isRonet) {
      createWisp(2.5, 18.0,  2.0,  0.0,  1.0, 0.25,  3.0, 0.06, 0.0, 1.0, 0.0, 0.0, 1.5);
      createWisp(2.0, 15.0,  4.5, 10.0,  1.2, 0.15,  4.0, 0.10, 0.0, 1.0, 1.0, 0.0, 1.8);
      createWisp(1.8, 16.0, -0.5, 25.0,  0.8, 0.20,  2.5, 0.08, 0.0, 1.0, 2.0, 0.0, 1.2);
      createWisp(3.0, 14.0,  2.5, 40.0,  0.7, 0.12,  2.0, 0.05, 4.5, 2.2, 3.0, 0.0, 2.0);
      createWisp(1.5, 15.0,  5.5, 55.0, 0.85, 0.18,  3.5, 0.14, 0.0, 1.8, 4.0, 1.0, 1.4);
    } else {
